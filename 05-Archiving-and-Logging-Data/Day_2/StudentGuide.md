...
- Add the above job to the bottom of the crontab file: 
...
Each directory contains several scripts, which run at dedicated time intervals. 
...
Note that one of the available commands is `audit`.
